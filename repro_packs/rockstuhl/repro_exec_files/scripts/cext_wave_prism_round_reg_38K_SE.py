...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'prism_reg_round_SE'
    ...
    numpy.savetxt('../results_data/prism_round_reg_SE_LE_res/'+'prism_round_reg_38K_short_edge'+'10-20microns.txt', 
    ...
    with open('../results_data/prism_round_reg_SE_LE_res/Time_'+'prism_round_reg_38K_short_edge'+'.txt', 'w') as f:
