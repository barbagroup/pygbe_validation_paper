...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'prism_reg_SE_y13K'
    ...
    numpy.savetxt('../results_data/prism_regular_SE_LE_res/'+'prism_reg_36K_SE_y13K'+'10-20microns.txt', 
    ...
    with open('../results_data/prism_regular_SE_LE_res/Time_'+'prism_reg_36K_SE_y13K'+'.txt', 'w') as f:
