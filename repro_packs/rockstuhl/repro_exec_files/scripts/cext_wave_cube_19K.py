...
def main(argv=sys.argv):
    ...
    field_dict_pillars = read_fields(full_path + 'cube_19K.config')
    ...
    numpy.savetxt('../results_data/cube_535nm_res/'+'cube_19K'+'10-20microns.txt', 
    ...
    with open('../results_data/cube_535nm_res/Time_'+'cube_19K'+'.txt', 'w') as f:
