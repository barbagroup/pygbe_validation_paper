...
def main(argv=sys.argv):
    ...
    numpy.savetxt('../results_data/prism_672x1344x328nm_res/'+'prism_36K_short_edge'+'10-20microns.txt', 
    ...
    with open('../results_data/prism_672x1344x328nm_res/Time_'+'prism_36K_short_edge'+'.txt', 'w') as f:
