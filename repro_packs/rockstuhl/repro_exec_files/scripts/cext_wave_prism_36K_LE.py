...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'prism_328x1344x672nm_LE'
    ...
    numpy.savetxt('../results_data/prism_672x1344x328nm_res/'+'prism_36K_long_edge'+'10-20microns.txt', 
    ...
    with open('../results_data/prism_672x1344x328nm_res/Time_'+'prism_36K_long_edge'+'.txt', 'w') as f:
