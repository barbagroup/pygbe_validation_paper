...
def main(argv=sys.argv):
    ...
    numpy.savetxt('../results_data/prism_regular_SE_LE_res/'+'prism_reg_38K_short_edge'+'10-20microns.txt', 
    ...
    with open('../results_data/prism_regular_SE_LE_res/Time_'+'prism_reg_38K_short_edge'+'.txt', 'w') as f:
