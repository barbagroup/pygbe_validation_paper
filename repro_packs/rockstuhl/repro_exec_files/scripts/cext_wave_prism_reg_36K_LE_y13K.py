...
def main(argv=sys.argv):
    ...
    numpy.savetxt('../results_data/prism_regular_SE_LE_res/'+'prism_reg_36K_LE_y13K'+'10-20microns.txt', 
    ...
    with open('../results_data/prism_regular_SE_LE_res/Time_'+'prism_reg_36K_LE_y13K'+'.txt', 'w') as f:
