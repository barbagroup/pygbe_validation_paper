...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'prism3280x26880x6720_LE'
    ...
    numpy.savetxt('../results_data/prism_SE_LE_res/'+'prism_34K_long_edge'+'10-20microns.txt', 
    ...
    with open('../results_data/prism_SE_LE_res/Time_'+'prism_34K_long_edge'+'.txt', 'w') as f:
