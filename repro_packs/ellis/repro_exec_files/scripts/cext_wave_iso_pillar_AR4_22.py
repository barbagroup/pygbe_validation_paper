...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'AR_4'
    ...
    numpy.savetxt('../results_data/iso_pillar_AR_22deg/'+'iso_pillar_AR_4_22deg'+'_800-1000cm-1_in_ang.txt', 
    ...
    with open('../results_data/iso_pillar_AR_22deg/Time_'+'iso_pillar_AR_4_22deg'+'_800-1000cm-1.txt', 'w') as f:
