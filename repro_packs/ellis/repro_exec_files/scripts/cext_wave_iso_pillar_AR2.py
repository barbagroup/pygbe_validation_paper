...
def main(argv=sys.argv):
    ...
    numpy.savetxt('../results_data/iso_pillar_AR/'+'iso_pillar_AR_2'+'_800-1000cm-1_in_ang.txt', 
    ...
    with open('../results_data/iso_pillar_AR/Time_'+'iso_pillar_AR_2'+'_800-1000cm-1.txt', 'w') as f:
