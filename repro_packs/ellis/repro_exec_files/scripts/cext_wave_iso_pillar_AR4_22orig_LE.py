...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'AR4_LE'
    ...
    numpy.savetxt('../results_data/iso_pillar_AR4_22/'+'iso_pillar_AR4_22_LE'+'_800-1000cm-1_in_ang.txt', 
    ...
    with open('../results_data/iso_pillar_AR4_22/Time_'+'iso_pillar_AR4_22_LE'+'_800-1000cm-1.txt', 'w') as f:
