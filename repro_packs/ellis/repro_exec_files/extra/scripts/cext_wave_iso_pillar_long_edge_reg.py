...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'iso_pillar_long_edge_reg_mesh'
    ...
    numpy.savetxt('../results_data/iso_pillar_reg/'+'iso_pillar_long_edge'+'_800-1000cm-1_in_ang.txt', 
    ...
    with open('../results_data/iso_pillar_reg/Time_'+'iso_pillar_long_edge'+'_800-1000cm-1.txt', 'w') as f:
