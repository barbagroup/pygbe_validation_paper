...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'iso_pillar_long_edge'
    ...
    numpy.savetxt('../results_data/iso_pillar/'+'iso_pillar_long_edge'+'20-32Hz_in_ang.txt', 
    ...
    with open('../results_data/iso_pillar/Time_'+'iso_pillar_long_edge'+'.txt', 'w') as f:
