...
def main(argv=sys.argv):
    ...
    folder_path = in_files_path + 'iso_pillar_LE_round_8K'
    ...
    numpy.savetxt('../results_data/iso_pillar_round/'+'iso_pillar_long_edge'+'_800-1000cm-1_in_ang.txt', 
    ...
    with open('../results_data/iso_pillar_round/Time_'+'iso_pillar_long_edge'+'_800-1000cm-1.txt', 'w') as f:
