...
a good candidate to replicate using \pygbe. [SAY WHY]
...
We measure extinction cross section, which will express as peaks instead of depressions (shown in the reflection plots of Ellis et al.). 
...
position was smaller than 1 cm$^{-1}$. This analysis led us to a mesh density of $\approx \; 1.7 \times10^{-5}$ to create the meshes for 
