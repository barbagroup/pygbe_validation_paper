...
results of the effect of uniformity and roundness. One can see that the second peak in the $E\parallel b$ plot located at $\approx$ 10.6 $\mu$m  is not
present in the green curve, and the intensity for the second peak in the $E\parallel a$ plot located at $\approx$ 10.6 $\mu$m diminishes. These effects can be attributed 
...
\begin{figure}
    ...
    parallel to the $z$-axis. Where the labels are \textbf{Trimesh}: for non-uniform mesh generated using Trimesh; 
    \textbf{Uniform}: for uniform mesh generated using python scripts; and 
    \textbf{Uni + round}: for uniform mesh generated using python scripts with round 
