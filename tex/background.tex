...
mid to long wave infrared. Nanostructures of these materials show figure of merits that exceed that are not possible using plasmonic metals. This effect is due to the properties 
...
When studying both Phonon Polaritons and Plasmons resonances, we can analyze the spectrums by measuring different quantities. We can measure scattering cross section, extinction cross section 
