...
\begin{abstract}
    ...
    electromagnetic excitation of nanoscale structures, where the quantity
    ...
    nanostructures. The main result replicates: the wavenumber
    position of the first mode, but for other modes the results differ.
