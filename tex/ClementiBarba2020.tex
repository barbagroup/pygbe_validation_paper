...
After we posted the preprint on arXiv (just after submission to the journal), we received communication from Prof. Dr. Carsten Rockstuhl that helped us clarify some points in our paper, which we appreciate.
